...
| 登录 & 验证    | 状態       | その他      | 状態      |
|----------------|-----------|-----------|-----------|
| QRコードログイン | ✅ 完了 | ライト/ダークテーマ | ✅ 完了 |
| パスワードログイン | ✅ 完了 | クリップボード監視 | ✅ 完了 |
| SMSログイン     | ✅ 完了 | HTTP プロキシ | ✅ 完了 |
| 自動ログイン更新 | ✅ 完了 | PCDN フィルター | ✅ 完了 |
| パラメータ署名   | ✅ 完了 | MP3 変換 | ✅ 完了 |
| リスク制御検証   | ✅ 完了 | 命名フォーマット | ✅ 完了 |
| 指紋認証        | ✅ 完了 | 履歴記録 | ✅ 完了 |
|                |          | オフラインキャッシュ管理 | ✅ 完了 |

**オフラインキャッシュ管理機能:**
- Bilibili オフラインキャッシュのディレクトリ構造を認識（コレクション対応）
- キャッシュファイルの一括選択・削除・転送
- M4S から MP4 形式への変換
- 複数選択時のスマート提案
